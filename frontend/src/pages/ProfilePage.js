...
const ProfilePage = () => {
  ...
  return (
    <PublicLayout>
      <ToastContainer position="top-cneter" autoClose={2000}/>
        ...
        <form onSubmit={handleSubmit} className='card p-4 shadow-sm border-0'>
          <div className="row">
            ...
            <div className="col-md-6 mb-3">
              ...
              <input type="text" className="form-control" name="mobile" value={formData.mobile} onChange={handleChange} disabled/>
            </div>

            <div className="col-md-6 mb-3">
              <label className='mb-1'>Registration Date</label>
              <input type="text" className="form-control" name="reg_date" value={new Date(formData.reg_date).toLocaleString()} onChange={handleChange} disabled/>
            </div>
          </div>
          <button type="submit" className="btn btn-primary mt-3"><i className="fas fa-save"></i> Update Profile</button>
        </form>
      </div>
    </PublicLayout>
  );
