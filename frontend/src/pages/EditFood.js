                ...
                <div className='p-4 shadow-sm rounded'>
                    ...
                    <form onSubmit={handleSubmit} encType='multipart/form-data'>
                        ...
                        <div className='mb-3'>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input name="image" type="file" accept="image/*" className='form-control' placeholder='' onChange={handleFileChange}/>
                                </div>
                                <div class="col-md-6">
                                    {formData.image && (
                                        <img src={`http://127.0.0.1:8000/${formData.image}`} className='img-fluid' style={{maxHeight:'100px', border:'1px solid red',borderRadius:'8px',padding:'4px'}} />
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="submit" className="btn btn-primary mt-2"><i className='fas fa-plus me-2'></i> Update Food Item</button>
                    </form>
                </div>
            </div>
